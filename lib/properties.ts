...
export const placeholderImage =
  ...
  encodeURIComponent(
    '<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="900"><rect width="100%" height="100%" fill="#efe9de"/><text x="50%" y="50%" font-family="Georgia,serif" font-size="42" fill="#b0a894" text-anchor="middle" dominant-baseline="middle">sem foto</text></svg>',
  )
